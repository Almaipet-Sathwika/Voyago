...
const propertiesData = [
  {
    ...
    price: 8500,
    description: "High-ceiling room in a 1920s home, courtyard breakfast, and rickshaw rides to Chinese fishing nets.",
    rating: 4.35,
    imageUrl: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=800&q=80",
    ownerName: "Thomas Kurian",
    ownerPhone: "+91 98470 12345",
    ownerEmail: "thomas.k@example.com",
    isVerified: true,
    securityDeposit: 15000,
    tags: ["Budget Friendly", "Family ready"],
  },
  {
    name: "Loft in the Arts District",
    location: "Los Angeles, California, USA",
    price: 24000,
    description: "Industrial-chic loft with 14-foot ceilings, vinyl listening corner, and walkable gallery nights.",
    rating: 4.8,
    imageUrl: "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=800&q=80",
    ownerName: "Sarah J. Parker",
    ownerPhone: "+1 213-555-0199",
    ownerEmail: "sarahp@example.com",
    isVerified: true,
    securityDeposit: 30000,
    tags: ["Near college", "Verified Owner"],
  },
  {
    name: "Brooklyn Brownstone Garden",
    location: "Brooklyn, New York, USA",
    price: 32000,
    description: "Classic brownstone with private backyard, chef's kitchen, and 20 minutes to Manhattan.",
    rating: 4.75,
    imageUrl: "https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=800&q=80",
    ownerName: "Michael Ross",
    ownerPhone: "+1 718-555-0123",
    ownerEmail: "mross@example.com",
    isVerified: true,
    securityDeposit: 40000,
    tags: ["No brokerage", "Family ready"],
  },
  {
    name: "Lisbon Alfama Terrace",
    location: "Alfama, Lisbon, Portugal",
    price: 18500,
    description: "Sun-drenched terrace over terracotta roofs, tram 28 at the corner, and pastel de nata mornings.",
    rating: 4.65,
    ...
    tags: ["Near college", "Budget Friendly"],
  },
  {
    name: "Tuscany Villa Olive Grove",
    location: "Chianti, Tuscany, Italy",
    price: 45000,
    description: "Stone farmhouse among olive trees, pool overlooking vineyards, and optional cooking classes.",
    rating: 4.9,
    imageUrl: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=800&q=80",
    ownerName: "Giuseppe Rossi",
    ownerPhone: "+39 055 123 4567",
    ownerEmail: "giuseppe.rossi@example.com",
    isVerified: true,
    securityDeposit: 60000,
    tags: ["Family ready", "No brokerage"],
  },
  {
    name: "Bali Jungle Bamboo House",
    location: "Ubud, Bali, Indonesia",
    price: 12000,
    description: "Open-air living among rice paddies, outdoor shower, and daily yoga shala five minutes away.",
    rating: 4.55,
    ...
    ownerEmail: "wayansuka@example.com",
    isVerified: true,
    securityDeposit: 15000,
  ...
  },
  {
    ...
    price: 15500,
    description: "Traditional hanok lines with heated ondol floors, smart home upgrades, and palace walks.",
    rating: 4.5,
    ...
    ownerEmail: "minsu.kim@example.com",
    isVerified: true,
    securityDeposit: 25000,
    tags: ["Near college", "Family ready"],
  },
];
